      ...
      <div className="relative bg-white/20 backdrop-blur-xl rounded-3xl border border-white/30 shadow-2xl transform transition-all hover:scale-[1.05] hover:shadow-3xl overflow-hidden">
        <div className="p-6 flex flex-col space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="flex flex-col items-center justify-center p-4 w-full bg-gradient-to-br from-green-300 to-green-500 rounded-2xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
              <div className="flex items-center space-x-2 text-white font-medium">
                <Clock className="w-5 h-5 sm:w-6 sm:h-6" />
                <span>Active</span>
              </div>
              <span className="mt-2 text-xl sm:text-2xl font-bold text-white">
                {activeTasks}
              </span>
            </div>

            <div className="flex flex-col items-center justify-center p-4 w-full bg-gradient-to-br from-blue-300 to-blue-500 rounded-2xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
              <div className="flex items-center space-x-2 text-white font-medium">
